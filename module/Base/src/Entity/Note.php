 ...
 * Version 3.0.3 (doctrine2-zf2inputfilterannotation) on 2018-11-27 15:14:20.
...
class Note implements InputFilterAwareInterface
{
    ...
    {
        $dataFields = array('id', 'title', 'content', 'create_time', 'user_username', 'update_time');
    ...
    {
        return array('id', 'title', 'content', 'create_time', 'user_username', 'update_time');
    }
}