 ...
 * @ORM\Table(name="menu", indexes={@ORM\Index(name="fk_menu_menu1_idx", columns={"parent_id"}), @ORM\Index(name="fk_menu_user1_idx", columns={"user_username"})})
 */
class Menu implements InputFilterAwareInterface
{
    ...
    {
        $dataFields = array('id', 'parent_id', 'user_username', 'name', 'order_id', 'url', 'target', 'params', 'is_display', 'update_time', 'layout', 'memo');
    ...
    {
        return array('id', 'parent_id', 'user_username', 'name', 'order_id', 'url', 'target', 'params', 'is_display', 'update_time', 'layout', 'memo');
    }
}