 ...
 * Version 3.0.3 (doctrine2-zf2inputfilterannotation) on 2018-02-08 08:03:54.
 ...
 * @ORM\Table(name="page", indexes={@ORM\Index(name="fk_page_menu1_idx", columns={"menu_id"}), @ORM\Index(name="fk_page_user1_idx", columns={"user_username"})})
 */
class Page implements InputFilterAwareInterface
{
    ...
    {
        $dataFields = array('id', 'menu_id', 'user_username', 'title', 'content', 'create_time', 'update_time', 'hits', 'url', 'tags', 'term', 'kind', 'url_target', 'order_id', 'link_menu', 'summary', 'is_published');
        $relationFields = array('user', 'menu');
        $copiedFields = array();
    ...
    {
        return array('id', 'menu_id', 'user_username', 'title', 'content', 'create_time', 'update_time', 'hits', 'url', 'tags', 'term', 'kind', 'url_target', 'order_id', 'link_menu', 'summary', 'is_published');
    }
}