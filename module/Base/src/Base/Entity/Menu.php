...
class Menu implements InputFilterAwareInterface
{
    ...
    {
        $dataFields = array('id', 'name', 'order_id', 'parent_id', 'url', 'target', 'params', 'is_display', 'update_time', 'user_id');
    ...
    {
        return array('id', 'name', 'order_id', 'parent_id', 'url', 'target', 'params', 'is_display', 'update_time', 'user_id');
    }
}