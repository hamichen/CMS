 ...
 * Version 2.1.6-dev (doctrine2-zf2inputfilterannotation) on 2015-07-17
 * 16:16:54.
...
class Page implements InputFilterAwareInterface
{
    ...
    {
        $dataFields = array('id', 'title', 'content', 'create_time', 'update_time', 'hits', 'url', 'tags', 'menu_id', 'user_id', 'term', 'kind', 'url_target', 'order_id');
    ...
    {
        return array('id', 'title', 'content', 'create_time', 'update_time', 'hits', 'url', 'tags', 'menu_id', 'user_id', 'term', 'kind', 'url_target', 'order_id');
    }
}